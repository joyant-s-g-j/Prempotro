  ...
  return (
    <div className="group relative">
      ...
      <div className="relative">
        <input 
          className="w-full px-5 py-3.5 bg-white/70 backdrop-blur-sm border-2 border-transparent focus:border-rose-400 rounded-2xl outline-none shadow-sm transition-all duration-300 placeholder:text-rose-300 focus:bg-white focus:shadow-[0_0_0_4px_rgba(255,107,157,0.15)] ring-offset-2 hover:bg-white/90"
          {...props}
        />
