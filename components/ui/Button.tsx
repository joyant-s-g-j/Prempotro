...
const Button = ({
  ...
  const variants = {
    primary: "text-white bg-gradient-to-r font-trio from-rose-500 via-pink-500 to-purple-500 bg-[length:200%_auto] hover:bg-[position:right_center] shadow-lg shadow-pink-500/30 hover:shadow-pink-500/50 hover:-translate-y-0.5",
    ...
    >
      ...
      {isLoading ? (
        <>
          ...
          <span className="font-trio">অপেক্ষা করুন...</span>
        </>
      ) : (
        children
      )}
